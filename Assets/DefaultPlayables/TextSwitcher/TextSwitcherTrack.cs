...
public class TextSwitcherTrack : TrackAsset
{
    ...
    {
#if UNITY_EDITOR
        TMPro.TMP_Text trackBinding = director.GetGenericBinding(this) as TMPro.TMP_Text;
        ...
        while (iterator.NextVisible(true))
        {
            ...
            driver.AddFromName<TMPro.TMP_Text>(trackBinding.gameObject, iterator.propertyPath);
        }
#endif
